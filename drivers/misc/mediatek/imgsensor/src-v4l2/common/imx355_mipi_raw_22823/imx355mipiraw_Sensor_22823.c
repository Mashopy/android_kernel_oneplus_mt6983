...
#include "imx355_ana_gain_table_22823.h"
#include "imx355mipiraw_Sensor_22823.h"
...
#define imx355_table_write_cmos_sensor_22823(...) subdrv_i2c_wr_regs_u8(__VA_ARGS__)

/************************Modify Following Strings for Debug********************/
#define PFX "IMX355_camera_sensor_22823"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = IMX355_SENSOR_ID_22823,
...
kal_uint16 addr_data_pair_init_imx355_22823[] = {
    0x0106, 0x01,
    0x0136, 0x18,
    0x0137, 0x00,
    0x4348, 0x16,
...
{
    LOG_INF("E\n");
    imx355_table_write_cmos_sensor_22823(ctx, addr_data_pair_init_imx355_22823,
        sizeof(addr_data_pair_init_imx355_22823)/sizeof(kal_uint16));
}    /*    sensor_init  */

kal_uint16 addr_data_pair_preview_imx355_22823[] = {
    0x0808, 0x02,
    0x0112, 0x0A,
    0x0113, 0x0A,
    0x0114, 0x03,
...
{
    LOG_INF("E %s.\n", __func__);
    imx355_table_write_cmos_sensor_22823(ctx, addr_data_pair_preview_imx355_22823,
    sizeof(addr_data_pair_preview_imx355_22823) / sizeof(kal_uint16));
    /* zvhdr_setting(ctx); */
    set_mirror_flip(ctx, ctx->mirror);
    LOG_INF("Leave: %s.\n", __func__);
}                /*    preview_setting  */

kal_uint16 addr_data_pair_capture_imx355_22823[] = {
    0x0808, 0x02,
    0x0112, 0x0A,
    0x0113, 0x0A,
    0x0114, 0x03,
...
static void capture_setting(struct subdrv_ctx *ctx, kal_uint16 currefps)
{
    ...
    imx355_table_write_cmos_sensor_22823(ctx, addr_data_pair_capture_imx355_22823,
    sizeof(addr_data_pair_capture_imx355_22823) / sizeof(kal_uint16));
    set_mirror_flip(ctx, ctx->mirror);
    LOG_INF("Leave: %s.\n", __func__);
}

kal_uint16 addr_data_pair_video_imx355_22823[] = {
    0x0808, 0x02,
    0x0112, 0x0A,
    0x0113, 0x0A,
    0x0114, 0x03,
...
static void normal_video_setting(struct subdrv_ctx *ctx, kal_uint16 currefps)
{
    ...
    imx355_table_write_cmos_sensor_22823(ctx, addr_data_pair_video_imx355_22823,
    sizeof(addr_data_pair_video_imx355_22823) / sizeof(kal_uint16));
    set_mirror_flip(ctx, ctx->mirror);
    LOG_INF("Leave: %s.\n", __func__);
}

kal_uint16 addr_data_pair_hs_video_imx355_22823[] = {
    0x0808, 0x02,
    0x0112, 0x0A,
    0x0113, 0x0A,
    0x0114, 0x03,
...
{
    LOG_INF("E %s.\n", __func__);
    imx355_table_write_cmos_sensor_22823(ctx, addr_data_pair_hs_video_imx355_22823,
    sizeof(addr_data_pair_hs_video_imx355_22823) / sizeof(kal_uint16));
    set_mirror_flip(ctx, ctx->mirror);
    LOG_INF("Leave: %s.\n", __func__);
}
...
static kal_uint16 slim_video_setting_array_22823[] = {
    0x0808, 0x02,
    0x0112, 0x0A,
    0x0113, 0x0A,
    0x0114, 0x03,
...
{
    LOG_INF("E %s.\n", __func__);
    imx355_table_write_cmos_sensor_22823(ctx, slim_video_setting_array_22823,
        sizeof(slim_video_setting_array_22823) / sizeof(kal_uint16));
    set_mirror_flip(ctx, ctx->mirror);
    LOG_INF("Leave: %s.\n", __func__);
}

static kal_uint16 custom1_setting_array_22823[] = {
    0x0808, 0x02,
    0x0112, 0x0A,
    0x0113, 0x0A,
    0x0114, 0x03,
...
{
    LOG_INF("E %s.\n", __func__);
    imx355_table_write_cmos_sensor_22823(ctx, custom1_setting_array_22823,
        sizeof(custom1_setting_array_22823) / sizeof(kal_uint16));
    set_mirror_flip(ctx, ctx->mirror);
    LOG_INF("Leave: %s.\n", __func__);
}

static kal_uint16 custom2_setting_array_22823[] = {
    0x0808, 0x02,
    0x0112, 0x0A,
    0x0113, 0x0A,
    0x0114, 0x03,
...
{
    LOG_INF("E %s.\n", __func__);
    imx355_table_write_cmos_sensor_22823(ctx, custom2_setting_array_22823,
        sizeof(custom2_setting_array_22823) / sizeof(kal_uint16));
    set_mirror_flip(ctx, ctx->mirror);
    LOG_INF("Leave: %s.\n", __func__);
}

static kal_uint16 custom3_setting_array_22823[] = {
    0x0808, 0x02,
    0x0112, 0x0A,
    0x0113, 0x0A,
    0x0114, 0x03,
...
{
    LOG_INF("E %s.\n", __func__);
    imx355_table_write_cmos_sensor_22823(ctx, custom3_setting_array_22823,
        sizeof(custom3_setting_array_22823) / sizeof(kal_uint16));
    set_mirror_flip(ctx, ctx->mirror);
    LOG_INF("Leave: %s.\n", __func__);
}

static kal_uint16 custom4_setting_array_22823[] = {
    0x0808, 0x02,
    0x0112, 0x0A,
    0x0113, 0x0A,
    0x0114, 0x03,
...
{
    LOG_INF("E %s.\n", __func__);
    imx355_table_write_cmos_sensor_22823(ctx, custom4_setting_array_22823,
        sizeof(custom4_setting_array_22823) / sizeof(kal_uint16));
    set_mirror_flip(ctx, ctx->mirror);
    LOG_INF("Leave: %s.\n", __func__);
}

static kal_uint16 custom5_setting_array_22823[] = {
    0x0808, 0x02,
    0x0112, 0x0A,
    0x0113, 0x0A,
    0x0114, 0x03,
...
{
    LOG_INF("E %s.\n", __func__);
    imx355_table_write_cmos_sensor_22823(ctx, custom5_setting_array_22823,
        sizeof(custom5_setting_array_22823) / sizeof(kal_uint16));
    set_mirror_flip(ctx, ctx->mirror);
    LOG_INF("Leave: %s.\n", __func__);
}
...
{
    kal_uint16 idx = 0;
    read_imx355_eeprom_info_22823(ctx, EEPROM_META_MODULE_ID,
                &(imx355_common_data[0]), 2);
    read_imx355_eeprom_info_22823(ctx, EEPROM_META_SENSOR_ID,
                &(imx355_common_data[2]), 2);
    read_imx355_eeprom_info_22823(ctx, EEPROM_META_LENS_ID,
                &(imx355_common_data[4]), 2);
    read_imx355_eeprom_info_22823(ctx, EEPROM_META_VCM_ID,
                &(imx355_common_data[6]), 2);
    read_imx355_eeprom_info_22823(ctx, EEPROM_META_MODULE_SN,
            ...
            ACDK_SENSOR_ENGMODE_STEREO_STRUCT * pStereodata)
{
	...
	if(pStereodata != NULL) {
		...
		if ((pStereodata->uSensorId == IMX355_SENSOR_ID_22823) && (data_length == CALI_DATA_SLAVE_LENGTH)
 ...
 */
    ...
    case SENSOR_FEATURE_GET_ANA_GAIN_TABLE:
        if ((void *)(uintptr_t) (*(feature_data + 1)) == NULL) {
            *(feature_data + 0) =
                sizeof(imx355_ana_gain_table_22823);
        } else {
            memcpy((void *)(uintptr_t) (*(feature_data + 1)),
            (void *)imx355_ana_gain_table_22823,
            sizeof(imx355_ana_gain_table_22823));
        }
        break;
...
const struct subdrv_entry imx355_mipi_raw_22823_entry = {
    .name = "imx355_mipi_raw_22823",
    .id = IMX355_SENSOR_ID_22823,
    .pw_seq = pw_seq,
